...
const Works = () => {
  ...
  let project = Projects.map((n) => {
    return (
      <section key={n.id} className="flex flex-wrap md:max-w-screen-xl items-center justify-evenly my-8 gap-4  p-4">
        <motion.div
          whileTap={{ scale: 0.7 }}
          ...
          <a href={n.web} alt={n.web} target="_blank" rel="noopener noreferrer">
            <img src={n.imageSrc}alt={n.name} className=" object-cover rounded-md my-4" />
          </a>
